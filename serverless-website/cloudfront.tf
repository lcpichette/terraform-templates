...
resource "aws_cloudfront_origin_access_control" "default_access_control" {
  name                              = "Origin CloudFront Access"
  description                       = "CF:S3 Access Policy"
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  origin {
    ...
    origin_access_control_id = aws_cloudfront_origin_access_control.default_access_control.id
